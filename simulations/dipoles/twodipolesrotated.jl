...
# Higher steps reduce errors in numerical integration, can use better numerical schemes to reduce steps
endTime = 1 # time till when we want to simulate
numFrames = endTime * 100 # number of frames in animation,
